...
// 全部为本地种子数据，时间锚定在 2026-09-24 ~ 2026-09-28
export const seed: SeedData = {
  ...
  berthPlan: [
    // P1/P2：同靠 B-01，重叠 2.5h / 较短 3.5h ≈ 0.71，严重冲突
    ...
    // P3/P4：同靠 B-02，重叠 3h / 较短 8h = 0.375，明显冲突
    ...
    // P6/P7：同靠 B-05，重叠 0.5h / 较短 4h = 0.125，轻度冲突
